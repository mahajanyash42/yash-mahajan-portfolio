...
export default async function ProjectPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <main className="case-page">
    <div className="case-nav section-shell"><Link href="/#projects"><ArrowLeft size={17}/> Back to portfolio</Link><div className="case-nav-links">{project.demo && <a href={project.demo} target="_blank" rel="noreferrer"><Globe size={17}/> Live demo <ArrowUpRight size={15}/></a>}<a href={project.github} target="_blank" rel="noreferrer"><Github size={17}/> GitHub <ArrowUpRight size={15}/></a></div></div>
